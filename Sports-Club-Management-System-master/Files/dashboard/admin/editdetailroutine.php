...
// Fetch all plans to populate the dropdown
$plan_result = mysqli_query($con, "SELECT pid FROM plan");
?>
                ...
                <div class="a1-card-8 a1-light-gray" style="width:600px; margin:0 auto;">
                    ...
                    <form id="form1" name="form1" method="post" class="a1-container" action="updateroutine.php">
                        <table width="619" height="673" border="0" align="center">
                            ...
                            <tr>
                                <td width='186' height='103'>Plan ID:</td>
                                <td height="87" colspan="2">
                                    <select name="pidd" required>
                                        <option value="" disabled>Select a Plan</option>
                                        <?php
                                        while ($plan_row = mysqli_fetch_assoc($plan_result)) {
                                            $selected = ($plan_row['pid'] === $row['pid']) ? "selected" : ""; // Check if this plan is selected
                                            echo "<option value='" . $plan_row['pid'] . "' $selected>" . $plan_row['pid'] . "</option>";
                                        }
                                        ?>
                                    </select>
                                </td>
                            ...
                            <tr>
                                <td height="96">Day 1:</td>
                                <td><textarea style="resize:none; margin: 0px; width: 230px; height: 53px;" name="day1" id="boxxe"><?php echo $row['day1'] ?></textarea></td>
                            </tr>
                            <tr>
